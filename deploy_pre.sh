...
# aws s3 sync --cache-control max-age=172800 . s3://tiledesk-dashboard-pre/angular-14.2.2/dashboard/
# # aws s3 sync ./index.html s3://tiledesk-dashboard-pre/dashboard/ --exclude='*' --include='/index.html'
# # aws cloudfront create-invalidation --distribution-id E2DTAKWHWQ7C3J --paths "/*"
# echo new version deployed on s3://tiledesk-dashboard-pre/angular-14.2.2/dashboard/
# echo available on https://support-pre.tiledesk.com/angular-14.2.2/dashboard/index.html
