...
aws s3 sync . s3://tiledesk-dashboard/dashboard/dev/1.0.40/
echo new version deployed on s3://tiledesk-dashboard/dashboard/dev/1.0.40/
echo available on https://support.tiledesk.com/dashboard/dev/1.0.40/index.html