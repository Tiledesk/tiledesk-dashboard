...
aws s3 sync . s3://tiledesk-dashboard/dashboard/dev/2.0.0-beta.3/
echo new version deployed on s3://tiledesk-dashboard/dashboard/dev/2.0.0-beta.3/
echo available on https://support.tiledesk.com/dashboard/dev/2.0.0-beta.3/index.html