...
aws s3 sync . s3://tiledesk-dashboard/dashboard/dev/2.0.0-beta.21/
echo new version deployed on s3://tiledesk-dashboard/dashboard/dev/2.0.0-beta.21/
echo available on https://support.tiledesk.com/dashboard/dev/2.0.0-beta.21/index.html