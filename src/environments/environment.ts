...
// export const environment = {
//   production: true,
//   t2y12PruGU9wUtEGzBJfolMIgK: 'PAY:F-ANA:T-ACT:T-TRI:T-GRO:T-DEP:T-OPH:T-MTL:T-CAR:T-V1L:T-PSA:T-MTT:T-SUP:T-LBS:T-APP:T-DEV:T-NOT:T-IPS:T-ETK:T-RAS:T-PPB:T-PET:T-MTS:T-TIL:T-DGF:T-NAT:T-HPB:F-TOW:T-KNB:T-BAN:T-AST:T-MON:T-CNT:T-AUT:T-WUN:T-INT:T-QIN:T-VAU:T-OVP:T', // -DPA:F no more used
...
//   CHAT_BASE_URL:  'http://localhost:50358/', //'https://panel.tiledesk.com/v3/chat/', 
...
//     remoteConfigUrl: './dashboard-config.json',
//     VERSION: require('../../package.json').version,
//     t2y12PruGU9wUtEGzBJfolMIgK: "PAY:F-ANA:T-ACT:T-TRI:T-GRO:T-DEP:T-OPH:T-MTL:T-CAR:T-V1L:T-PSA:T-MTT:T-SUP:F-LBS:T-APP:T-DEV:T-NOT:T-IPS:T-ETK:T-RAS:T-PPB:T-PET:T-MTS:T-TIL:T-DGF:T-NAT:T-HPB:F-TOW:T-KNB:T-BAN:T-AST:T-MON:T-CNT:T-AUT:T-WUN:T-INT:T-QIN:T-VAU:T-OVP:T-GPT:T-TKT:F-MPA:F",
//     widgetUrl: 'https://aruba.tiledesk.com/widget/launch.js',
//     botcredendialsURL: 'CHANGEIT',
//     SERVER_BASE_URL: 'https://aruba.tiledesk.com/api/',
//     CHAT_BASE_URL: 'https://aruba.tiledesk.com/chat/', //  'http://localhost:8100/#/chat',
