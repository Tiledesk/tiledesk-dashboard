...
if (
  (window.location.href.indexOf('/unserved-request-for-panel') >= 0) || 
  (window.location.href.indexOf('%2Funserved-request-for-panel') >= 0) || 
  (window.location.href.indexOf('/projects-for-panel') >= 0) || 
  (window.location.href.indexOf('%2Fprojects-for-panel') >= 0) || 
  (window.location.href.indexOf('/request-for-panel') >= 0) || 
  (window.location.href.indexOf('%2Frequest-for-panel') >= 0) ||
  (window.location.href.indexOf('/cds') >= 0) ||
  (window.location.href.indexOf('%2Fcds') >= 0) ||
  (window.location.href.indexOf('/onboarding') >= 0) ||
  (window.location.href.indexOf('%2Fonboarding') >= 0) ||
  (window.location.href.indexOf('/create-new-project') >= 0) ||
  (window.location.href.indexOf('%2Fcreate-new-project') >= 0)
  ) 
