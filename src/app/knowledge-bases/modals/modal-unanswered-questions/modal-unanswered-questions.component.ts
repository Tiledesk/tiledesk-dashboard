...
export class ModalUnansweredQuestionsComponent implements OnInit, OnChanges {
  /** Numero massimo di caratteri dell’anteprima risposta (chiusa); oltre → "…" e pulsante Mostra tutto. */
  ...
  /** Testo risposta mostrato in lista: troncato a caratteri fissi se chiuso, intero se espanso. */
