...
export const ELEMENTS_LIST = [
    ...
    { name: 'Ask the KnowledgeBase', type: TYPE_ACTION.ASKGPT, category: TYPE_ACTION_CATEGORY.INTEGRATIONS, src: "assets/cds/images/actions/ask_to_kb.svg", description: 'This action forwards the question to ChatGPT' },
...
export const ACTIONS_LIST= {
    ...
    ASKGPT: { name: 'Ask the KnowledgeBase', type: TYPE_ACTION.ASKGPT, category: TYPE_ACTION_CATEGORY.INTEGRATIONS, src: "assets/cds/images/actions/ask_to_kb.svg", description: 'This action forwards the question to ChatGPT' },
