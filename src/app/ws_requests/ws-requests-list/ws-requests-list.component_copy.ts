...
export class WsRequestsListComponent extends WsSharedComponent implements OnInit {
  ...
  listenToRequestsLength() {
    ...
    this.wsRequestsService.wsRequestsListLength$.subscribe((totalrequests: number) => {
      console.log('% »»» WebSocketJs WF - onData (ws-requests-list) ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ done -> data.length ', totalrequests)
  ...
  getWsRequests$() {
    ...
    .subscribe((wsrequests) => {
      if (wsrequests) {
        ...
        // setTimeout(() => {
        //   this.countRequestsLength(wsrequests)
        // }, 5000)

        // for (const value of wsrequests) {
        //   // value += 1;
        ...
        // let requests = [].reduce((promiseChain, item) => {
        ...
        // console.log('% »»» WebSocketJs WF WS-RL - WsRequestsList  ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ REQUESTS ARRAY: ', wsrequests);
      ...
      this.ws_requests.forEach((request, index, array) => {

        // console.log('%%% WsRequestsList getWsRequests$ typeof ws_request ', typeof wsrequests)
        // console.log('% »»» WebSocketJs WF WS-RL - WsRequestsList  ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ REQUEST: ', request);
        // console.log('% »»» WebSocketJs WF WS-RL - WsRequestsList  ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ REQUEST index: ', index);
        // console.log('% »»» WebSocketJs WF WS-RL - WsRequestsList  ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ REQUEST ARRAY LENGTH: ', array.length);

        // var itemsProcessed = 0

        // setTimeout(() => {
        //   console.log('% »»» WebSocketJs WF WS-RL - WsRequestsList  ≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥≥ HO FINITO ',);
        //   this.showSpinner = false;
        //   this.SHOW_SIMULATE_REQUEST_BTN = false;
        // }, index * 1000)
  ...
  trackByFn(index, request) {    
    ...
    return request._id; // unique id corresponding to the item
 }
