...
export class WidgetSharedComponent implements OnInit {
  ...
  languages = [
    ...
    { code: 'de', name: 'German', type: '--- Needs own translation ---' },
    ...
    { code: 'pt', name: 'Portuguese', type: '--- Needs own translation ---' },
    ...
    { code: 'ru', name: 'Russian', type: '--- Needs own translation ---' },
    ...
    { code: 'es', name: 'Spanish, Castilian', type: '--- Needs own translation ---' },
    ...
    { code: 'tr', name: 'Turkish', type: '--- Needs own translation ---' },
