...
export class HomeCreateTeammateComponent implements OnInit {
  ...
  getPendingInvitation() {
    this.usersService.getPendingUsers()
      .subscribe((pendingInvitation: any) => {
        ...
        console.error('[HOME-CREATE-TEAMMATE] - GET PENDING INVITATION - ERROR', error);
      }, () => {
        console.log('[HOME-CREATE-TEAMMATE] - GET PENDING INVITATION * COMPLETE *');
      });
  }
    ...
    this.prjctPlanService.projectPlan$
      ...
      .subscribe((projectProfileData: any) => {
        ...
        if (projectProfileData) {
          ...
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - projectPlanAgentsNo ', this.projectPlanAgentsNo);

          this.prjct_profile_type = projectProfileData.profile_type;
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - prjct_profile_type ', this.prjct_profile_type);

          this.subscription_is_active = projectProfileData.subscription_is_active;
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - subscription_is_active ', this.projectPlanAgentsNo);
          this.subscription_end_date = projectProfileData.subscription_end_date
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - subscription_end_date ', this.subscription_end_date);
          this.profile_name = projectProfileData.profile_name
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - profile_name ', this.profile_name);
          this.trial_expired = projectProfileData.trial_expired
          // console.log('[HOME-CREATE-TEAMMATE]  - GET PROJECT PROFILE - trial_expired ', this.trial_expired);
            ...
            if (this.subscription_is_active === true) {
              if (projectProfileData.profile_name === PLAN_NAME.A) {
                if (!this.appSumoProfile) {
                  ...
                  console.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - PLAN_NAME ', PLAN_NAME.A, ' SEATS LIMIT: ', this.seatsLimit)
                  ...
                  console.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - prjct_profile_name ', this.prjct_profile_name, ' SEATS LIMIT: ', this.seatsLimit)
                }
                ...
                if (!this.appSumoProfile) {
                  ...
                  this.seatsLimit = PLAN_SEATS[PLAN_NAME.B]
                  console.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - PLAN_NAME ', PLAN_NAME.B, ' SEATS LIMIT: ', this.seatsLimit)
                  this.logger.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - prjct_profile_name: ', this.prjct_profile_name)
                } else {
                ...
                console.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - PLAN_NAME ', PLAN_NAME.C, ' SEATS LIMIT: ', this.seatsLimit)
                this.logger.log('[HOME-CREATE-TEAMMATE] - GET PROJECT PLAN - prjct_profile_name: ', this.prjct_profile_name)
              }
            }
  ...
  getLoggedUser() {
    this.auth.user_bs.subscribe((user) => {
      //  console.log('[HOME-CREATE-TEAMMATE]  - LOGGED USER ', user)
      if (user) {
  ...
  presentModalInviteTeammate() {
    console.log('[HOME-CREATE-TEAMMATE] - presentModalAddKb ');
    const addKbBtnEl = <HTMLElement>document.querySelector('#home-material-btn'); 
    console.log('[HOME-CREATE-TEAMMATE] - presentModalAddKb addKbBtnEl ', addKbBtnEl);
    addKbBtnEl.blur()
    ...
    dialogRef.afterClosed().subscribe(result => {
      console.log(`[HOME-CREATE-TEAMMATE] Dialog result:`, result);

      if (result) {
        if (result.email && result.role)  {
          console.log(`[HOME-CREATE-TEAMMATE] email:`, result.email, ' role ', result.role);
  ...
  doInviteUser(email, role){
    ...
    this.usersService.inviteUser(email, role).subscribe((project_user: any) => {
      console.log('[HOME-CREATE-TEAMMATE] - INVITE USER - POST SUBSCRIPTION PROJECT-USER - RES project_user)', project_user);
      console.log('[HOME-CREATE-TEAMMATE] - INVITE USER - POST SUBSCRIPTION PROJECT-USER - RES project_user.id_project', project_user.id_project);
      // console.log('[HOME-CREATE-TEAMMATE]  - INVITE USER - POST SUBSCRIPTION PROJECT-USER - RES project_user.role', project_user.role);
      ...
      // console.error('[HOME-CREATE-TEAMMATE] - INVITE USER  ERROR BODY ', invite_error);
     ...
     console.log('[HOME-CREATE-TEAMMATE] - INVITE USER  * COMPLETE *');
      // this.INVITE_YOURSELF_ERROR = false;
