...
const LINE_CHART_GRID = { left: 0, right: 8, top: 12, bottom: 52, containLabel: true };
...
function timelineInsideDataZoom(): EChartsOption['dataZoom'] {
  return [
    {
      type: 'inside',
      xAxisIndex: 0,
      filterMode: 'none',
      minValueSpan: ONE_HOUR_MS,
...
function timelineSliderDataZoom(): EChartsOption['dataZoom'] {
  return [
    {
      type: 'slider',
      xAxisIndex: 0,
...
export function buildTeammateActivitiesTimelineChartOption(
  ...
  return {
    ...
    dataZoom: timelineInsideDataZoom(),
    yAxis: {
      type: 'value',
      min: 0,
      max: 2,
...
export function buildTeammateActivitiesSliderChartOption(bounds: TimelineAxisBounds): EChartsOption {
  return {
    ...
    dataZoom: timelineSliderDataZoom(),
  };
}
