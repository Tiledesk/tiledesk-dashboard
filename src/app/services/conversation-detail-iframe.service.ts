...
export class ConversationDetailIframeService {
  ...
  // Configurazione
  private readonly IFRAME_URL = 'https://stage.eks.tiledesk.com/chat/#/conversation-detail/';
  ...
  private createGlobalContainer(): void {
    let existing = document.getElementById(this.CONTAINER_ID);
    if (existing) {
    ...
    this.iframeContainer.style.height = 'calc(100vh - 70px)';
