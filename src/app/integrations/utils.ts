...
export const INTEGRATION_LIST_ARRAY = [
    ...
    { name: "MCP",                   category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.MCP,             src_icon: "assets/img/int/mcp-icon.png",                    src_logo: "assets/img/int/mcp-logo.png",                pro: true,  plan: 'Pro' },
