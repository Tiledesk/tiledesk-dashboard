...
export const INTEGRATION_LIST_ARRAY = [
    ...
    { name: "Google Gemini",         category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.GOOGLE,          src_icon: "assets/img/int/google-gemini-icon.svg",          src_logo: "assets/img/int/google_gemini_logo_2.svg",      pro: true,  plan: 'Custom' },
