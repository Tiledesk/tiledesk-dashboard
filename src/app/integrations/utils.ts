...
export const INTEGRATION_LIST_ARRAY = [
    ...
    { name: "OpenAI",                category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.OPENAI,          src_icon: "assets/img/int/openai-icon.svg",                 src_logo: "assets/img/int/openai-logo.svg",             pro: true,  plan: 'Premium' },
    { name: "Google Gemini",         category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.GOOGLE,          src_icon: "assets/img/int/google-gemini-icon.svg",          src_logo: "assets/img/int/google_gemini_logo.svg",      pro: true,  plan: 'Premium' },
    { name: "Claude",                category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.ANTHROPIC,       src_icon: "assets/img/int/claude-icon.svg",                 src_logo: "assets/img/int/claude_logo.svg",             pro: true,  plan: 'Premium' },
    { name: "Groq",                  category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.GROQ,            src_icon: "assets/img/int/groq-icon.svg",                   src_logo: "assets/img/int/groq_logo.svg",               pro: true,  plan: 'Premium' },
    { name: "Cohere",                category: INTEGRATIONS_CATEGORIES.AI,               key: INTEGRATIONS_KEYS.COHERE,          src_icon: "assets/img/int/cohere_icon.svg",                 src_logo: "assets/img/int/cohere_logo.svg",             pro: true,  plan: 'Premium' },
