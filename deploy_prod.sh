...
# aws s3 sync --cache-control max-age=172800 . s3://panel.tiledesk.com/v3/dev/dashboard/
# ## aws s3 sync ./index.html s3://tiledesk-console/v2/dashboard/ --exclude='*' --include='/index.html'
# ## aws s3 sync ./index.html s3://tiledesk-console/v2/dashboard/ --cache-control max-age=0
# echo new version deployed on s3://panel.tiledesk.com/v3/dev/dashboard/
# echo available on https://panel.tiledesk.com/v3/dev/dashboard/index.html
