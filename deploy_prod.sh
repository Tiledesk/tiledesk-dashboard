...
aws s3 sync --cache-control max-age=172800 . s3://panel.tiledesk.com/v3/dashboard/minimal
aws cloudfront create-invalidation --distribution-id E2D4FS8NGUODM4 --paths "/*"
echo new version deployed on s3://panel.tiledesk.com/v3/dashboard/minimal
echo available on https://panel.tiledesk.com/v3/dashboard/minimal/index.html
